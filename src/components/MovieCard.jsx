...
function MovieCard({ movie }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 right-2 bg-yellow-400 text-black text-xs font-bold px-2 py-1 rounded-lg shadow">
      ...
      <div className="absolute inset-0 border-2 border-transparent group-hover:border-green-500 rounded-2xl transition duration-300"></div>
    </div>
  );
}
